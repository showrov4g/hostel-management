...
const UpdateMealsDetails = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (res.data.success) {
      ...
      const mealRes = await axiosSecure.patch(`/meals/update/${id}`, updateData);
        console.log(mealRes.data);
      if (mealRes.data.modifiedCount===1) {
        Swal.fire({
          position: "top-end",
          icon: "success",
...
export default UpdateMealsDetails;
