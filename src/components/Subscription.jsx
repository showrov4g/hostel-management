...
const Subscription = () => {
  ...
  return (
    <div className="my-20">
      ...
      <div>
        <div className="card bg-[#3f8acd] bg-opacity-10 hover:bg-opacity-15  h-80 shadow-xl hover:scale-105 transition-all duration-500">
      ...
      <div>
      <div className="card bg-[#3f8acd] bg-opacity-15 hover:bg-opacity-15  h-80 shadow-xl  hover:scale-105 transition-all duration-500">
          <div className="card-body">
      ...
      <div>
      <div className="card bg-[#3f8acd] bg-opacity-15 hover:bg-opacity-15  h-96 md:h-80 shadow-xl  hover:scale-105 transition-all duration-500">
          <div className="card-body">
